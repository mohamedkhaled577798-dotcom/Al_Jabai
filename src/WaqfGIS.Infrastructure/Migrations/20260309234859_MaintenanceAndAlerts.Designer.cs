...
namespace WaqfGIS.Infrastructure.Migrations
{
    ...
    [Migration("20260309234859_MaintenanceAndAlerts")]
    partial class MaintenanceAndAlerts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaqfGIS.Core.Entities.AlertNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WaqfGIS.Core.Entities.EncroachmentPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EncroachmentId");

                    b.ToTable("EncroachmentPhotos");
                });

            modelBuilder.Entity("WaqfGIS.Core.Entities.EncroachmentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("AuthorityReportDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<decimal?>("EncroachmentAreaSqm")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("EncroachmentType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EncroachwrName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EncroachwrNationalId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EncroachwrPhone")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsReportedToAuthorities")
                        .HasColumnType("bit");

                    b.Property<int?>("LegalDisputeId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ReportReferenceNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WaqfGIS.Core.Entities.MaintenancePhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WaqfGIS.Core.Entities.MaintenanceRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WaqfGIS.Core.Entities.Mosque", b =>
                {
                    ...
                    b.Property<string>("WaqfConditionText")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("WaqfDocumentDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("WaqfDocumentNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WaqfGIS.Core.Entities.WaqfProperty", b =>
                {
                    ...
                    b.Property<bool>("IsResidentialOccupancy")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("OccupantMinistry")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OccupantNationalId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WaqfGIS.Core.Entities.EncroachmentPhoto", b =>
                {
                    b.HasOne("WaqfGIS.Core.Entities.EncroachmentRecord", "Encroachment")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("WaqfGIS.Core.Entities.EncroachmentRecord", b =>
                {
                    b.HasOne("WaqfGIS.Core.Entities.LegalDispute", "LegalDispute")
                        .WithMany()
                        .HasForeignKey("LegalDisputeId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("WaqfGIS.Core.Entities.MaintenancePhoto", b =>
                {
                    b.HasOne("WaqfGIS.Core.Entities.MaintenanceRecord", "Maintenance")
                        .WithMany("Photos")
